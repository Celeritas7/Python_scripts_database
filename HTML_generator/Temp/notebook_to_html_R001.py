...
def get_table_css() -> str:
    """CSS for table styling with zebra stripes and bold headers/first column"""
    return """
/* Table styles */
table {{
...
/* Index column (first column) - extra padding */
th:first-child,
td:first-child {{
    padding-left: 12px;
    padding-right: 12px;
...
Examples:
    ...
    parser.add_argument('-o', '--output', help='Output HTML file (default: same name with .html)')

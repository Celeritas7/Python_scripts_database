...
def get_table_css() -> str:
    """CSS for table styling matching PDF reference - full width, compact, gray header/index"""
    return """
/* Table styles */
table {
...
/* Index column (first column) - gray background like header */
tbody th {
    background-color: #d9d9d9 !important;
    font-weight: 700;
    text-align: center !important;
...
/* Data cells - white background, left aligned */
tbody td {
    background-color: #ffffff;
    text-align: right !important;
}

/* First header cell (empty corner) */
...
/* Reset code-output centering for tables */
.code-output {
    text-align: left;
}
"""
